...
在做 App 从 0 到上线的过程中，我发现每次推进项目都要反复粘贴 Prompt、手动串联文档、输出质量参差不齐。我把这套流升级为这套 Skill 库，轻松搞定app产品的项目管理、设计需求整理、项目开发设计及上架合规管理，能够加速项目的从0到1.让原来需要2-3个月从需求到上线的节奏，缩短到1个月内。
